...
E2Helper.Descriptions["line()"] = "Returns the current line in the code where it is called"
E2Helper.Descriptions["linechar()"] = "Returns the current character (from the line) in the code where it is called"
