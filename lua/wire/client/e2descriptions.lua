...
-- Unknown
E2Helper.Descriptions["dynamicCall(st)"] = "Invoke function via dynamic dispatch, using table values as arguments (must be wrapped as 'unknown')"
E2Helper.Descriptions["dynamicCall(sts)"] = "Invoke function via dynamic dispatch, using table values as arguments (must be wrapped as 'unknown'), and a return value is wrapped as 'unknown'"
